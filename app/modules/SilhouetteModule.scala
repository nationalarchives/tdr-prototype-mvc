...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  @Provides
  def provideCognitoProvider(
    httpLayer: HTTPLayer,
    socialStateHandler: SocialStateHandler,
    configuration: Configuration): CognitoProvider = {

    new CognitoProvider(httpLayer, socialStateHandler, configuration.underlying.as[OAuth2Settings]("silhouette.cognito"))
  }
